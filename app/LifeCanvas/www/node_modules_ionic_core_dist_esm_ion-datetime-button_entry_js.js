...
/* harmony import */ var _data_B9iGR5YO_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./data-B9iGR5YO.js */ 31815);
...
const DatetimeButton = class {
  constructor(hostRef) {
     ...
     */
    this.waitForDatetimeChanges = /*#__PURE__*/(0,E_1_Repository_LifeCanvas_Angular_Ionic_app_LifeCanvas_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      const {
        datetimeEl
      } = _this;
      if (!datetimeEl) {
    ...
    this.presentOverlay = /*#__PURE__*/function () {
      var _ref3 = (0,E_1_Repository_LifeCanvas_Angular_Ionic_app_LifeCanvas_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (ev, needsPresentationChange, triggerEl) {
        const {
          overlayEl
        } = _this;
        if (!overlayEl) {
